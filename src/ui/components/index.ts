...
export { IconLayers, IconFloorPlan, IconPalette, IconSparkle, IconMap, IconWalk, IconHead, IconSpeed, IconQuality, IconFullscreen, IconFullscreenExit, IconVolumeOn, IconVolumeOff } from './Icon';
