...
const styles: Record<string, React.CSSProperties> = {
  ...
  header: { display: 'flex', alignItems: 'center', gap: 8, fontSize: 12, color: '#374151' },
  title: { flex: 1, fontWeight: 600 },
  yaw: { fontFamily: 'ui-monospace, monospace', color: '#d97706' },
  closeBtn: {
  ...
  overlay: {
    ...
    background: 'rgba(31,41,55,0.55)', borderRadius: 6,
    pointerEvents: 'none',
  },
  ...
  hint: { fontSize: 10.5, color: 'rgba(31,41,55,0.5)', lineHeight: 1.5 },
};
